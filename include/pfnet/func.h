...
void FUNC_list_count_step(Func* f, Bus* bus, BusDC* busdc, int t);
void FUNC_list_allocate(Func* f);
void FUNC_list_clear(Func* f);
void FUNC_list_analyze_step(Func* f, Bus* bus, BusDC* busdc, int t);
void FUNC_list_eval_step(Func* f, Bus* bus, BusDC* busdc, int t, Vec* var_values);
...
void FUNC_eval_step(Func* f, Bus* bus, BusDC* busdc, int t, Vec* var_values);
