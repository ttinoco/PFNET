...
void CONSTR_list_eval_step(Constr* clist, Branch* br, int t, Vec* v, Vec* ev);
...
void CONSTR_eval(Constr* c, Vec* v, Vec* ev);
void CONSTR_eval_step(Constr* c, Branch* br, int t, Vec* v, Vec* ev);
...
BOOL CONSTR_is_safe_to_eval(Constr* c, Vec* v, Vec* ev);
