/** @file func_P_LOSS.h
 *  @brief This file lists the constants and routines associated with the function of type P_LOSS.
 *
...
#ifndef __FUNC_P_LOSS_HEADER__
#define __FUNC_P_LOSS_HEADER__
