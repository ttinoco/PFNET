/** @file constr_VSC_DC_PSET.h
 *  @brief This file lists the constants and routines associated with the constraint of type VSC_DC_PSET.
 *
...
#ifndef __CONSTR_VSC_DC_PSET_HEADER__
#define __CONSTR_VSC_DC_PSET_HEADER__
...
void CONSTR_VSC_DC_PSET_eval_step(Constr* c, Bus* bus, BusDC* busdc, int t, Vec* v, Vec* ve);
