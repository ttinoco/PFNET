...
void FUNC_REG_RATIO_count_branch(Func* f, Branch *branch);
void FUNC_REG_RATIO_allocate(Func* f);
void FUNC_REG_RATIO_clear(Func* f);
void FUNC_REG_RATIO_analyze_branch(Func* f, Branch *branch);
void FUNC_REG_RATIO_eval_branch(Func* f, Branch* branch, Vec* var_values);
