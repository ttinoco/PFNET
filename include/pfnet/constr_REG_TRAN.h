...
void CONSTR_REG_TRAN_count_step(Constr* c, Bus* bus, int t);
void CONSTR_REG_TRAN_analyze_step(Constr* c, Bus* bus, int t);
void CONSTR_REG_TRAN_eval_step(Constr* c, Bus* bus, int t, Vec* v, Vec* ve);
void CONSTR_REG_TRAN_store_sens_step(Constr* c, Bus* bus, int t, Vec* sA, Vec* sf, Vec* sGu, Vec* sGl);
