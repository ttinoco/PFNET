...
cdef extern from "pfnet/branch.h":
    ...
    REAL BRANCH_get_i_km_mag(Branch* br, cvec.Vec* var_values, int t, REAL eps)
    REAL BRANCH_get_i_mk_mag(Branch* br, cvec.Vec* var_values, int t, REAL eps)
    REAL BRANCH_get_S_km_mag(Branch* br, cvec.Vec* var_values, int t)
    REAL BRANCH_get_S_mk_mag(Branch* br, cvec.Vec* var_values, int t)
